...
// Embeds the Ontario First Nations Map via CDN blob URL
...
export default function OntarioMap({ className = "" }: OntarioMapProps) {
  ...
  if (error) {
    return (
      <div className={`flex items-center justify-center bg-[#FAF6F0] rounded-lg border border-[#e0d5c8] ${className}`} style={{ height: "500px" }}>
  ...
  return (
    <>
      ...
      <div className={`relative ${className}`}>
        {loading && (
          <div className="flex items-center justify-center bg-[#FAF6F0] rounded-lg" style={{ height: "500px" }}>
